...
class PredictionForm(FlaskForm):
    ...
    sop = FloatField('Statement of Purpose (SOP)', validators=[DataRequired(), NumberRange(min=1, max=10)])
    lor = FloatField('Letter of Recommendation (LOR)', validators=[DataRequired(), NumberRange(min=1, max=10)])
