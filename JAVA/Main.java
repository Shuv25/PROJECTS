...
class Hotel {
    ...
    static void bill(int rn, int rtype, int k) {
        double amount = 0;
        ...
        switch (rtype) {
            ...
            case 2:
                amount += (3000 * k);
                System.out.println("Room Charge - " + 3000 * k);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
            ...
            case 3:
                amount += (2200 * k);
                System.out.println("Room Charge - " + 2200 * k);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
            ...
            case 4:
                amount += (1200 * k);
                System.out.println("Room Charge - " + 1200 * k);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
    ...
    static void deallocate(int rn, int rtype, int k) {
        int j;
        char w;
        switch (rtype) {
            case 1:
                ...
                switch (ch) {
                    ...
                    case 5:
                        ...
                        if (ch2 > 60)
                            ...
                            Hotel.deallocate(ch2 - 41, 4, ch3);
                        else if (ch2 > 30)
                            Hotel.deallocate(ch2 - 31, 3, ch3);
                        else if (ch2 > 10)
                            Hotel.deallocate(ch2 - 11, 2, ch3);
                        else if (ch2 > 0)
                            Hotel.deallocate(ch2 - 1, 1, ch3);
                        else
                            System.out.println("Room doesn't exist");
                        break;
                    case 6:
